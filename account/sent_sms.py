...
class SendSmsApiWithEskiz:
    ...
    def get_status(self, id):
        ...
        CHECK_STATUS_URL = 'http://notify.eskiz.uz/api/message/sms/status/' + \
            str(id)
...
def sent_sms_to_phone_number(phone_number):
    code = random.randint(10000, 99999)
    eskiz_api = SendSmsApiWithEskiz(message=code, phone=phone_number)
    try:
        eskiz_api.send()
        return code
    except:
